...
class Map extends React.Component {
                ...
                if (this.state.passData.wherelatitude == 0 || this.state.passData.droplatitude == 0) {
                    this.setState(
                        ...
                        () => {
                            ...
                            obj.whereText = json.results[0].formatted_address;
                            obj.droplatitude = location.coords.latitude;
                            obj.droplongitude = location.coords.longitude;
                            obj.dropText = json.results[0].formatted_address;
                            this.setState({
                                passData: obj,
                                mapChanging: true,
                            });
    ...
    async onCarType(value) {
        ...
        if (this.state.availableDrivers.length > 0) {
            ...
            this.setState({ loading: false });
            this.refs.toast.show("No available drivers", DURATION.LENGTH_LONG);
        }
    }
    onTab(value) {
        ...
        if (this.state.selectedDriver == 0) {
            ...
            if (type == 1) {
                if (
                    ...
                    this.setState({ loading: false });
                    this.refs.toast.show("'Please charge your wallet balance from your payment'", DURATION.LENGTH_LONG);
                        ...
                        <View
                            ...
                            <View
                                ...
                                <Image
                                    pointerEvents="none"
                                    style={{ marginBottom: 40, height: 40, resizeMode: 'contain' }}
                                    source={require('@assets/images/pink_pin.png')}
