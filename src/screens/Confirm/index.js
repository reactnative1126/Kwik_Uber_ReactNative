                ...
                <SafeAreaView style={{ flex: 1 }}>
                    ...
                    <ScrollView>
                        <View style={{ width: '100%', paddingLeft: 20, paddingRight: 20, alignItems: 'center', marginBottom: 50 }}>
                            <Image style={{ width: 100, height: 100, borderRadius: 50 }} source={images.img_avatar} />
                            ...
                            <View style={styles.driverItem}>
                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    <Image style={styles.driverImage} source={images.img_driver} />
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%' }}>
                                ...
                                <TouchableOpacity style={[styles.rideBtn, { width: '48%' }]} onPress={() => this.props.navigation.navigate('Accepts')}>
