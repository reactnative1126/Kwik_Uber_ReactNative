...
import { colors } from '@constacts/theme';
import  language  from '@constacts/language';
                ...
                <View style={styles.divCompView}>
                    <View style={styles.containsView}>
                        <View style={styles.statusStyle}>
                            ...
                            {item.type?item.type == 'Credit'?<Text style={styles.historyamounttextStyle}>{item.type + 'ed '+ this.state.settings.symbol + parseFloat(item.amount).toFixed(2) + ' '+ language.successfully}</Text>:
                                <Text style={styles.historyamounttextStyle}>{item.type + 'ed '+ this.state.settings.symbol + parseFloat(item.amount).toFixed(2)+ ' '+ language.form_wallet}</Text>
                            :null}
