...
const drivers = [
    { index: 1, type: 1, image: images.uber, title: 'Uber Black', description: '(Recommend)', time: 5, active: false },
    { index: 2, type: 1, image: images.lyft, title: 'Lyft Premier', description: '(Recommend)', time: 7, active: false },
    { index: 3, type: 2, image: images.driver, title: 'Jane Pohlson', description: 'Audi A6 Sedan', time: 4.9, active: false },
    { index: 4, type: 2, image: images.driver, title: 'James Bond', description: 'Benzu A6 Sedan', time: 3.9, active: false },
]
